...
import { CusIcon } from "./";
const VideoPlayer = ({ navigation, url }) => {
    ...
    const toggleOrientation = async () => {
        ...
        ScreenOrientation.lockAsync(await orientation);
        ...
        <View style={styles.container}>
            ...
            <View style={styles.controls}>
                ...
                <TouchableOpacity onPress={shareVideo}>
                    <Text style={styles.controlText}>
                        <CusIcon bg="bg-gray-100/50" name="share-social" />
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={toggleOrientation}>
                    <Text style={styles.controlText}>
                        <CusIcon
                            bg="bg-gray-100/50"
                            name={isPortrait ? "contract" : "expand"}
                        />
                    </Text>
                </TouchableOpacity>
            </View>

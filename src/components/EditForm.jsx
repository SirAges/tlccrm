...
import { CusIcon, DatePicker, FilePicker, Separator } from "./";
const EditForm = ({ name, multiple, action }) => {
    const { handleInputChange, value, setObj, obj, formArray, setValue } =
    ...
    return (
        <View className="absolute top-0 right-0 flex-1 bg-white">

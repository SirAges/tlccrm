...
const SMinistryScreen = ({ navigation, route }) => {
    const { ministry: m } = route.params;
    ...
    const handleDelete = id => {
        const deleteItem = async () => {
            try {
                ...
                navigation.navigate("MinistryScreen");
            }
        };
        Alert.alert(
...
export default SMinistryScreen;

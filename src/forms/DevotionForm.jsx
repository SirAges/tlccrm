...
const DevotionForm = ({ route, navigation }) => {
    ...
    const { title, text, body, memoryVerse, prayers } = value;
    const canCreate =
        [title, text, body, memoryVerse.body, memoryVerse.text, prayers].every(
            Boolean
        ) &&
        (!adding || !updating);

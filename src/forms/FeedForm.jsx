...
const FeedForm = ({ route, navigation }) => {
    ...
    const [updateFeed] = useUpdateMinFeedMutation();
    const [addNewFeed] = useAddNewMinFeedMutation();
    const [updateAnnouncement] = useUpdateMinAnnouncementMutation();
    const [addNewAnnouncement] = useAddNewMinAnnouncementMutation();
    const [updateCoc] = useUpdateMinCocMutation();
    const [addNewCoc] = useAddNewMinCocMutation();

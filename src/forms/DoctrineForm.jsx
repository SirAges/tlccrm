...
const DoctrineForm = ({ route, navigation }) => {
    ...
    const canCreate =
        [title,text,body].every(Boolean) && (!adding || !updating);
    ...
    const handleFormSubmit = async () => {
        ...
        try {
            ...
            navigation.navigate("DoctrineScreen");
        }
    };

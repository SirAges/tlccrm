...
import {
    useAddNewVisionMutation,
    useUpdateVisionMutation
} from "../redux/vision/visionApiSlice";
const VisionForm = ({ route, navigation }) => {
    ...
    const handleFormSubmit = async () => {
        ...
        try {
            ...
            navigation.navigate("VisionsScreen");
        }
    };
